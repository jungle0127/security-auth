...
public class ImageCodeGenerator implements IValidateCodeGenerator {
	...
	public ImageCode generate(ServletWebRequest request) {
		...
		int width = ServletRequestUtils.getIntParameter(request.getRequest(), "width", configWidth);
		int configHeight = this.securityProperties.getValidateCode().getImageCode().getHeight();
		int height = ServletRequestUtils.getIntParameter(request.getRequest(), "height", configHeight);
